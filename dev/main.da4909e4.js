...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../src/connection.js":[function(require,module,exports) {
var connection;
var connectionInfoElement = document.querySelector('#connection-info');
var connectionForm = document.querySelector('#connection-form');
var connectBtn = document.querySelector('#connect-btn');
connectBtn.addEventListener('click', function () {
  connect();
});
var messageForm = document.querySelector('#message-form');
var messageBtn = document.querySelector('#send-message-btn');
messageBtn.addEventListener('click', function () {
  sendMessage();
}); //Player 1

var loadConnectionId = function loadConnectionId() {
...
var connect = function connect() {
  var connectionId = connectionForm.connectionId.value;
  var peer = new Peer(null);
...
},{"core-js/library/fn/array/from":"../node_modules/core-js/library/fn/array/from.js"}],"../src/game-board.js":[function(require,module,exports) {
"use strict";
...
var buildBoard = function buildBoard() {
  var _iterator = _createForOfIteratorHelper(boardsArray),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var boardElement = _step.value;
...
},{"./connection":"../src/connection.js","./game-board":"../src/game-board.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
